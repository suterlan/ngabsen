<button @click="darkMode=!darkMode" type="button" class="relative inline-flex flex-shrink-0 h-6 transition-colors duration-200 ease-in-out border-2 border-transparent rounded-full cursor-pointer bg-indigo-800 dark:bg-transparent ring-2 ring-indigo-600 w-11 focus:outline-none focus:ring-2" role="switch" aria-checked="false">
