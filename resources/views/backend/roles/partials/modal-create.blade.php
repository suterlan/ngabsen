<x-modal name="create-roles" focusable>
  ...
  <form action="{{route('admin.roles')}}" method="POST" class="p-6">
    @csrf
  <div class="mt-4">
    <div>
      <x-input-label for="name" :value="__('Nama')" />
      <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="Nama Role" />
    ...
    <div>
      ...
      <div x-data="multiselect" x-init="loadOptions('select')" class="w-full flex flex-col items-center h-64 mx-auto">
